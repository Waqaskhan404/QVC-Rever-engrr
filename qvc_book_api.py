...
PASSPORT_NUMBER   = "YC9157711"
VISA_NUMBER       = "382026108904"
    ...
    while True:
        ...
        try:
            ...
            while time.time() - token_start < TOKEN_LIFETIME:
                ...
                # Phase 1: scan all months → collect all slots
                urgent_slots = []
                normal_slots = []
                got_429   = False
                ...
                for (year, month) in year_months:
                    ...
                    for date_str in available_dates:
                        ...
                        slots = fetch_slots(
                            sess, token, date_str,
                            target_vsc["vscId"], enc_visa, enc_pass, sponsor_type_ids,
                        )
                ...
                # Sort each list by date then time
                ...
                # Discord alert — urgent section + normal section
